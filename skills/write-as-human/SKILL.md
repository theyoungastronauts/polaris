...
> Condensed from [tropes.fyi](https://tropes.fyi) by [ossama.is](https://ossama.is)
...
1. **Negative parallelism** — Count "not X — it's Y" constructions. More than one is suspect.
2. **Bold-first bullets** — If every list item starts bold, restructure.
3. **Em-dash count** — More than 3 in a piece? Trim.
4. **Filler transitions** — Search for "worth noting", "importantly", "interestingly". Delete all.
5. **Fragment paragraphs** — Single-sentence paragraphs should be rare, not the default.
